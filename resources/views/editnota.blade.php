<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex-auto text-center text-2xl mt-4 mb-4 dark:text-white">Editar nota de {{ $alumno->nombre }} {{ $alumno->apellidos }}</div>
            
                <form method="POST" action="/alumno/{{ $alumno->id }}/{{ $nota->id }}/update" class="w-1/2 mx-auto">
    
                    <div class="form-group mb-4">
                        <label for="asignatura" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asignatura</label>
                        <input type='text' name='asignatura' id="asignatura" value="{{ $nota->asignatura }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></input>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type='text' name='nota' id="nota" value="{{ $nota->nota }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></input>
                        @if ($errors->has('nota'))
                    ...
                    <div class="form-group mb-4">
                        <button type="submit" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Actualizar Nota</button>
